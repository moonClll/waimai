...
namespace {
struct qt_meta_tag_ZN6dishesE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6dishesE = QtMocHelpers::stringData(
    "dishes",
    "signaltocalPayment",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6dishesE[] = {
...
Q_CONSTINIT const QMetaObject dishes::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6dishesE.offsetsAndSizes,
    qt_meta_data_ZN6dishesE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6dishesE_t,
        // Q_OBJECT / Q_GADGET
...
void dishes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (dishes::*)();
            if (_q_method_type _q_method = &dishes::signaltocalPayment; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *dishes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6dishesE.stringdata0))
